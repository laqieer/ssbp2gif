    ...
    for n in range(num_parts):
        ...
        for key, dtype in PART.items():
            try:
                ...
                print('DEBUG INFO get_part_data_array EXCEPTION: key='+str(key)+', dtype='+dtype)
        ...
        for n in range(num_parts):
            ...
            for key, dtype in FRAME_DATA.items():
                try:
                    ...
                    print('DEBUG INFO4 get_frame_data_array EXCEPTION:key='+str(key))
            ...
            if sp_flag & V_SCALE:
                ...
                try:
                    ...
                    print('DEBUG INFO5 EXCEPTION:key=v_scale')
...
def main():
    ...
    for animation in frame_data_json:
        with open('framesJSON_'+animation+'.js', 'wt') as out:
            ...
            out.write("}")
        print('[OK] framesJSON_'+animation+'.js')
